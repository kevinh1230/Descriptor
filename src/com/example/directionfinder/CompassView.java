...
public class CompassView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		// if (bearing != null)
		// canvas.rotate(-bearing*360/(2*3.14159f), centerx, centery);
		//canvas.drawLine(centerx, -1000, centerx, +1000, markerPaint);
		//canvas.drawLine(-1000, centery, 1000, centery, markerPaint);
		canvas.drawLine(centerx,centery,600,-280,markerPaint);
		for (int i = 0; i < 24; i++) {
			// Draw a marker.
